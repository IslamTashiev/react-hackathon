...
import ContactFilterPage from "./views/CatalogFilterPage";
...
import CatalogFilterPage from "./views/CatalogFilterPage";
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/catalogfilter" element={<CatalogFilterPage />} />
